export const PAGES = [
  { id: 'landscape', name: 'Ink landscape', zh: '山水', group: 'Nature', title: 'A little room\nto wander.', description: 'Date-seeded mountains, quiet water, and a new horizon each day.', detail: 'Generative ink · a different landscape every day' },
  { id: 'almanac', name: 'Daily almanac', zh: '黃曆', group: 'Daily', title: 'Every day,\na fresh page.', description: 'The Gregorian and lunar calendars, seasonal markers, and the rhythm of the everyday.', detail: 'Chinese almanac · light and evening editions' },
  { id: 'poem', name: 'A daily poem', zh: '詩箋', group: 'Daily', title: 'Make space\nfor a few words.', description: 'A Tang poem from a collection of 135, with an English reading close at hand.', detail: '135 Tang poems · a new reading each day' },
  { id: 'character', name: 'One character', zh: '一字', group: 'Daily', title: 'One character.\nA whole world.', description: 'A generous study of a Chinese character, its meaning, and the words it becomes.', detail: 'Daily character · pinyin, meaning, and compounds' },
  { id: 'flora', name: 'Seasonal flora', zh: '四君子', group: 'Nature', title: 'Let the season\ncome inside.', description: 'Plum, orchid, bamboo, and chrysanthemum, drawn afresh as the year unfolds.', detail: 'The Four Gentlemen · procedural botanical prints' },
  { id: 'weather', name: 'Island weather', zh: '天氣', group: 'Daily', title: 'A feeling\nfor the day.', description: 'Singapore’s outlook, temperatures, air quality, and the chance of rain.', detail: 'Singapore · NEA and Open-Meteo at render time' },
  { id: 'month', name: 'The month', zh: '月曆', group: 'Calendar', title: 'A wider view\nof what’s ahead.', description: 'A considered month calendar with lunar dates, Singapore holidays, and calendar event markers.', detail: 'Month view · lunar dates and public holidays' },
  { id: 'year', name: 'Year in progress', zh: '歲時', group: 'Calendar', title: 'Watch a year\nbecome a life.', description: 'One square for every day. A quiet record of time passed and time still to come.', detail: 'Year progress · holidays and milestones' },
  { id: 'photo', name: 'Your photographs', zh: '相片', group: 'Personal', title: 'Keep something\nclose to you.', description: 'A daily photograph, translated into the four colors of e-paper and given room to breathe.', detail: 'Your photo rotation · four-color gallery prints' },
  { id: 'joke', name: 'Local vocabulary', zh: '俚語', group: 'Personal', title: 'A small dose\nof local color.', description: 'A playful dictionary of Singlish profanity, with polite puns and everyday examples.', detail: 'Singlish humor · contains strong language' },
];
